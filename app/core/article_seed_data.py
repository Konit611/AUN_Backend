"""Legacy hard-coded article content. Used only by scripts/seed_articles.py
to bootstrap the article / article_category tables. Runtime endpoints query
those tables; subsequent edits go through the admin UI.
"""

CATEGORY_FILTERS = [
    {"key": "all", "label": "すべて"},  # virtual filter, not seeded
