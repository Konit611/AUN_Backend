"""Legacy hard-coded pairing-guide content. Only used by scripts/seed_pairing_guide.py
to bootstrap the pairing_category / pairing_item tables. The runtime endpoint
queries these tables; future edits go through the admin UI.
"""
